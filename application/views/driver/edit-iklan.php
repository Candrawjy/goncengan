            ...
            <div class="card-body">
              <div class="form-body">
                ...
                <div class="mb-4">
                  ...
                  <select class="form-control rounded-3" id="setwaktu" onChange="opsi(this)" name="wo">
                    <option value="">-- Pilih Waktu --</option>
                    <option value="berangkat">Waktu Berangkat Saja</option>
                    <option value="pulang">Waktu Pulang Saja</option>
                    <!-- <option value="keduanya">Keduanya</option> -->
                  </select>
                  <small class="text-danger"><?=form_error('wo')?></small>
                </div>
                <div class="mb-3">
                  <label class="form-label">Waktu Berangkat <small class="text-danger">(Target Waktu Tiba di Kampus)</small></label>
                  <input type="time" class="form-control rounded-3" name="waktu_berangkat" value="<?=set_value('waktu_berangkat')?>" id="waktu-berangkat" disabled>
                  <small class="text-danger"><?=form_error('waktu_berangkat')?></small>
                </div>
                <div class="mb-3">
                  <label class="form-label">Waktu Pulang</label>
                  <input type="time" class="form-control rounded-3" name="waktu_pulang" value="<?=set_value('waktu_pulang')?>" id="waktu-pulang" disabled>
